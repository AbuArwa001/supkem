...
const AdminSidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "w-[300px] h-screen sticky top-0 bg-[#0A1A14] border-r border-white/5 flex flex-col z-[60] text-slate-300 transition-transform duration-300 ease-in-out",
          "fixed lg:sticky",
      ...
      >
        ...
        <Link
          href="/"
          className="p-8 pb-6 flex items-center gap-4 cursor-pointer"
        >
