                    ...
                    >
                        ...
                        <div className="p-8 rounded-[32px] bg-primary/[0.02] border border-primary/10 flex items-center justify-between">
                            ...
                            <div className="text-right">
                                <p className="text-3xl font-bold text-primary">KES {Number(app.service_fee || 0).toLocaleString()}</p>
                                <p className="text-xs font-bold text-foreground/40 tracking-widest uppercase mt-1">Standard Processing Fee</p>
                            </div>
                        </div>

                        {app.marriage_details && (
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-slate-50/50 p-8 rounded-3xl border border-slate-100">
                                        <div className="space-y-4">
                                            <p className="text-[10px] font-black uppercase tracking-widest text-blue-600">Husband (Groom)</p>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">Name</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.husband_name}</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">ID / Passport</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.husband_id_passport}</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">Age & Status</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.husband_age} | {app.marriage_details.husband_marital_status}</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">Occupation</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.husband_occupation}</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">Residence</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.husband_residence_sub_county}, {app.marriage_details.husband_residence_county}</p>
                                            </div>
                                        </div>

                                        <div className="space-y-4">
                                            <p className="text-[10px] font-black uppercase tracking-widest text-rose-600">Wife (Bride)</p>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">Name</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.wife_name}</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">ID / Passport</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.wife_id_passport}</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">Age & Status</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.wife_age} | {app.marriage_details.wife_marital_status}</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">Occupation</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.wife_occupation}</p>
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-sm font-bold text-slate-400">Residence</p>
                                                <p className="font-bold text-slate-800">{app.marriage_details.wife_residence_sub_county}, {app.marriage_details.wife_residence_county}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-amber-50/30 p-8 rounded-3xl border border-amber-100/50">
                                        <div className="space-y-2">
                                            ...
                                            <div className="mt-4 space-y-3">
                                                <p className="text-sm font-medium"><span className="text-slate-400">Waliyy:</span> <span className="font-bold">{app.marriage_details.wife_waliyy_name}</span> ({app.marriage_details.wife_waliyy_relationship})</p>
                                                <p className="text-sm font-medium"><span className="text-slate-400">Agreed Mahr:</span> <span className="font-bold">{app.marriage_details.agreed_mahr}</span></p>
                                                <p className="text-sm font-medium"><span className="text-slate-400">Payment status:</span> <span className="font-bold uppercase text-amber-600">{app.marriage_details.paid_mahr_and_deferred}</span></p>
                                                {app.marriage_details.particulars_of_gifts && (
                                                    <p className="text-sm font-medium"><span className="text-slate-400">Gifts:</span> <span className="font-bold">{app.marriage_details.particulars_of_gifts}</span></p>
                                                )}
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            <div className="mt-4 space-y-3">
                                                <p className="text-sm font-medium"><span className="text-slate-400">Place:</span> <span className="font-bold">{app.marriage_details.place_of_marriage}, {app.marriage_details.county_of_marriage}</span></p>
                                                <p className="text-sm font-medium"><span className="text-slate-400">Date:</span> <span className="font-bold">{new Date(app.marriage_details.date_of_marriage).toLocaleDateString(undefined, { dateStyle: 'long' })}</span></p>
                                                <p className="text-[10px] font-black uppercase text-slate-400 mt-2">Witnesses</p>
                                                <p className="text-xs font-bold text-slate-600">1. {app.marriage_details.witness_1_name} (ID: {app.marriage_details.witness_1_id})</p>
                                                <p className="text-xs font-bold text-slate-600">2. {app.marriage_details.witness_2_name} (ID: {app.marriage_details.witness_2_id})</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 bg-slate-50/50 p-8 rounded-3xl border border-slate-100">
                                        <div className="space-y-1">
                                            ...
                                            <p className="font-bold text-slate-800">{app.pilgrim_details.full_name}</p>
                                        </div>
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Passport Number</p>
                                            <p className="font-bold text-slate-800">{app.pilgrim_details.passport_number}</p>
                                        </div>
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Nationality</p>
                                            <p className="font-bold text-slate-800">{app.pilgrim_details.nationality}</p>
                                        </div>
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Date of Birth</p>
                                            <p className="font-bold text-slate-800">{new Date(app.pilgrim_details.date_of_birth).toLocaleDateString()}</p>
                                        </div>
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Gender</p>
                                            <p className="font-bold text-slate-800">{app.pilgrim_details.gender}</p>
                                        </div>
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Trip Type</p>
                                            <p className="font-bold text-primary uppercase">{app.pilgrim_details.trip_type}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-blue-50/30 p-8 rounded-3xl border border-blue-100/50">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Expected Travel</p>
                                                <p className="font-bold text-slate-800">{new Date(app.pilgrim_details.expected_travel_date).toLocaleDateString(undefined, { dateStyle: 'full' })}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Travel Agent</p>
                                                <p className="font-bold text-slate-800">{app.pilgrim_details.travel_agent_name || "Self Managed / None"}</p>
                                            </div>
                                        </div>
                                    </div>

                                    {app.pilgrim_details.guidance_requested && (
                                        <div className="p-6 rounded-3xl bg-amber-50 border border-amber-100 flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-amber-700 font-medium mt-1">Applicant has requested educational and logistical guidance for this pilgrimage.</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
