...
export default function CertificatesPage() {
  ...
  // Group certificates by service
  const groupedCertificates = certificates.reduce((acc: any, cert: any) => {
    const serviceName = cert.application_detail?.service_name || "Other Certificates";
    if (!acc[serviceName]) {
      acc[serviceName] = [];
    }
    ...
    <div className="space-y-8 pb-20 max-w-7xl mx-auto">
      ...
      <div className="space-y-12">
        {isLoading ? (
          ...
          Object.entries(groupedCertificates).map(([serviceName, serviceCerts]: [string, any]) => (
