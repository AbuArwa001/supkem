...
import {
  ...
  ShieldCheck, Calendar, Hash, User, Phone, Mail, CreditCard
} from "lucide-react";
...
function InvoicePageContent() {
  ...
  if (!app) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 text-slate-500 gap-4">
        ...
        <button onClick={() => router.push("/portal/applications")} className="text-sm text-[#0b4a2d] font-black underline">
  ...
  const paidAt = payment?.updated_at ? new Date(payment.updated_at) : new Date();
  ...
  return (
    <div className="min-h-screen bg-slate-100 py-10 px-4 print:bg-white print:py-0 print:px-0">
      ...
      <div
        ref={printRef}
        className="max-w-4xl mx-auto bg-white rounded-[32px] shadow-2xl shadow-slate-200/60 overflow-hidden print:shadow-none print:rounded-none"
      >
        {/* Header banner */}
        <div
          className="relative px-12 py-10 bg-[#0b4a2d] text-white overflow-hidden"
          style={{ backgroundImage: "url('/payment-bg.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundBlendMode: "soft-light" }}
        >
          ...
          <div className="relative z-10 mt-10 pt-8 border-t border-white/10 flex items-end justify-between">
            ...
            <div className="text-right space-y-1">
              ...
              <p className="text-white font-bold text-lg">{paidAt.toLocaleDateString("en-GB", { day: "numeric", month: "long", year: "numeric" })}</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-12 py-10 space-y-10">
              ...
              <div className="space-y-3">
                ...
                {user?.phone_number && (
                  <div className="flex items-center gap-3 pl-1">
                    ...
                    <p className="text-sm text-slate-600 font-semibold">{user.phone_number}</p>
                  </div>
                )}
              </div>
            </div>
          ...
          <div>
            ...
            <div className="rounded-2xl overflow-hidden border border-slate-100">
              ...
              <div className="px-6 py-4 grid grid-cols-12 items-center border-t border-slate-100 bg-slate-50/50">
                <div className="col-span-7">
                  <p className="font-semibold text-slate-500 text-sm">Service Charge</p>
                </div>
              ...
              <div className="px-6 py-4 grid grid-cols-12 items-center border-t border-slate-100 bg-slate-50/50">
                <div className="col-span-7">
                  <p className="font-semibold text-slate-500 text-sm">VAT (Included)</p>
                </div>
                <div className="col-span-2 text-center font-semibold text-slate-400 text-sm">—</div>
                <div className="col-span-3 text-right font-bold text-slate-500 text-sm">KES 0</div>
              </div>
              ...
              <div className="px-6 py-6 grid grid-cols-12 items-center border-t-2 border-[#0b4a2d]/10 bg-gradient-to-r from-[#0b4a2d]/5 to-transparent">
                <div className="col-span-7">
                  <p className="font-black text-[#0b4a2d] text-lg uppercase tracking-wider">Total Paid</p>
                </div>
                <div className="col-span-2" />
                <div className="col-span-3 text-right">
                  <p className="font-black text-[#0b4a2d] text-3xl">KES {fee.toLocaleString()}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-dashed border-slate-200 pt-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 font-medium mt-0.5">This receipt was generated automatically upon successful M-Pesa confirmation.</p>
              </div>
            </div>
          ...
          <div className="text-center pt-4 border-t border-slate-100">
            <p className="text-xs text-slate-400 font-medium leading-relaxed">
              Thank you for your payment. This is an official receipt from SUPKEM — Supreme Council of Kenya Muslims.<br />
