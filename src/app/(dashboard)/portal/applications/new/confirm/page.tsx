...
function ConfirmPageContent() {
  ...
  const [status, setStatus] = useState<
    "idle" | "initiating" | "waiting" | "success" | "error"
  >("idle");
  ...
  const displayRef = appId
    ? `APP-${appId.split("-").pop()?.toUpperCase()}`
    : "PENDING";
    ...
    try {
      ...
      setErrorMsg(
        err.response?.data?.detail ||
          "Failed to initiate M-Pesa push. Please try again.",
      );
    }
  };
    ...
    const interval = setInterval(async () => {
      ...
      try {
        ...
        if (payStatus === "Completed") {
          ...
          setStatus("error");
          setErrorMsg(
            "The M-Pesa payment was declined or cancelled. Please ensure you entered the correct PIN and have sufficient balance, then try again.",
          );
          clearInterval(interval);
        } else if (attempts >= maxAttempts) {
          setStatus("error");
          setErrorMsg(
            "Payment confirmation timed out. If you completed the M-Pesa prompt, please wait a moment and refresh this page.",
          );
          clearInterval(interval);
        }
      } catch {
      ...
      <div className="w-full max-w-6xl animate-in fade-in slide-in-from-bottom-8 duration-700 relative z-10">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-5">
            ...
            <div>
              <h1 className="text-4xl font-black font-outfit text-white tracking-tight drop-shadow-lg">
                Secure Checkout
              </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-white/10 backdrop-blur-xl rounded-[16px] shadow-2xl border border-white/20 overflow-hidden p-8">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-xs uppercase tracking-widest font-bold text-white/40 mt-1">
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-[11px] font-black uppercase tracking-[0.2em] text-white/40 mb-2 ml-1">
                    Service Requested
                  </p>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl px-4 py-3">
                      <p className="font-bold text-white text-sm">
                        {appData?.submitted_at
                          ? new Date(appData.submitted_at).toLocaleDateString(
                              "en-GB",
                            )
                          : "Today"}
                      </p>
          ...
          <div className="lg:col-span-7">
            <div className="bg-black/30 backdrop-blur-xl rounded-[40px] shadow-2xl overflow-hidden relative border border-white/20">
              ...
              <div className="p-10 border-b border-white/10 relative z-10">
                <h3 className="text-white/60 text-xs font-black uppercase tracking-[0.2em] mb-6">
                  Payment Summary
                </h3>
                ...
                <div className="pt-6 mt-6 border-t border-white/10 flex justify-between items-end">
                  <span className="text-white/60 font-black uppercase tracking-widest text-sm mb-1">
                    Total Due
                  </span>
                ...
                {status === "idle" && (
                  <div className="space-y-8 animate-in fade-in duration-500">
                    ...
                    <p className="text-[11px] text-center text-white/40 font-bold uppercase tracking-wider mt-2">
                      Prompt sent securely to your device. Pin confirmation
                      required.
                    </p>
                  </div>
                )}
                  ...
                  <div className="flex flex-col items-center justify-center text-center space-y-6 animate-in zoom-in duration-500">
                    ...
                    <div>
                      ...
                      <p className="text-white/50 font-medium mt-2 text-lg">
                        Handshaking with Safaricom M-Pesa
                      </p>
                    </div>
                  </div>
                )}
                ...
                {status === "success" && (
                  <div className="flex flex-col items-center justify-center text-center space-y-6 animate-in zoom-in duration-500">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 mt-2 font-medium text-lg">
