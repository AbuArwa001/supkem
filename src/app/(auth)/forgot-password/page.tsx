...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await api.post("/users/users/request_password_reset/", {
        email,
      });
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-4 mb-16">
            ...
            <div className="space-y-1">
              <h2 className="text-2xl font-black font-outfit text-primary tracking-tighter uppercase">
                SUPKEM
              </h2>
      ...
      <div className="hidden lg:flex flex-1 relative bg-primary overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 p-20 text-center space-y-8 max-w-2xl text-white">
          ...
          <p className="text-lg text-white/70 leading-relaxed font-light">
            Follow the steps to regain access to your SUPKEM portal safely. Your
